...
from api.v1.views.course_view import AvailableCoursesViewSet, CourseViewSet, GroupViewSet, LessonViewSet
...
v1_router.register(r'courses_available', AvailableCoursesViewSet, basename='courses_available')
v1_router.register(
